...
DOCKERIMAGES=oinia2/aws-spring-web:0.81
...
sudo docker service create --name test2 -p 80:8080 --mount type=volume,source=$CONTAINERREPO,target=/app --replicas 2 $DOCKERIMAGES init
